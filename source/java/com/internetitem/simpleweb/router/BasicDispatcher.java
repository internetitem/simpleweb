...
public class BasicDispatcher implements Dispatcher {
	...
	public BasicDispatcher(Params params, Router router, Map<String, ControllerInstance> controllerMap) {
		this.params = params;
		this.router = router;
	...
	public static void dispatchInternal(DispatchInfo dispatchInfo) throws HttpError, ServletException, IOException {
		ControllerBase controller = dispatchInfo.getController();
